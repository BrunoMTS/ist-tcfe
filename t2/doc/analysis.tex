...
\includegraphics[width=0.8\linewidth]{rc2.pdf}
...
\begin{figure}[h] \centering
\includegraphics[width=0.7\linewidth]{natural_response.eps}
...
\begin{figure}[h] \centering
\includegraphics[width=0.5\linewidth]{forced_response.eps}
...
\subsection{Computation of the final total solution $v6(t)$}
...
\begin{figure}[H] \centering
\includegraphics[width=0.5\linewidth]{total_solution.eps}
...
\begin{figure}[h] \centering
\includegraphics[width=0.6\linewidth]{at51.eps}
\caption{Bode diagram (magnitude in dB's) of $v_6(t)$ }
\label{fig:51}
\end{figure}

\begin{figure}[H] \centering
\includegraphics[width=0.6\linewidth]{at52.eps}
\caption{Bode diagram (magnitude in dB's) of $v_6(t)$ and $v_c(t)$}
\end{figure}

\begin{figure}[H] \centering
\label{fig:52}
\includegraphics[width=0.6\linewidth]{at53.eps}
\caption{{Bode diagram (phase in degrees) of $v_6(t)$ } }
\label{fig:53}
\end{figure}

\begin{figure}[H] \centering
\includegraphics[width=0.6\linewidth]{at54.eps}
